...
unless AttachmentsController.included_modules.include?(ZipAttachments::Patches::AttachmentsControllerPatch)
  AttachmentsController.send(:include, ZipAttachments::Patches::AttachmentsControllerPatch)
end
